...
public class GameNetwork : MonoBehaviour
{
    ...
    private string m_ip = "192.168.43.128";//"10.161.21.42";// "114.119.6.48";
    ...
    public void SendCmd(CmdNumber cmdNumber, IExtensible cmd)
    {
        ...
        if (cmd != null)
        {
            ...
            ProtoBuf.Serializer.Serialize<IExtensible>(mem5, cmd);
    ...
    public object AnalysisMessage(Message message, System.Type type2)
    {
      ...
      //  ProtoBuf.Serializer.
        ...
        //object ss = ProtoBuf.Serializer.Deserialize<object>(mem1);
     //   var objType = Type.GetType(object);

        return RuntimeTypeModel.Default.Deserialize(mem1, null, type2);
    }
