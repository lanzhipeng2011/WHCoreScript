...
public class LoginMgr 
{
	...
	//test env
	public string m_ip = "192.168.43.128";//"10.161.21.42"; // "119.147.215.27";
	public ushort m_port = 8000;
	private ushort m_game = 3;
	public ushort m_zone = 5;	// lyb=5, csc=4, zdf=3
	//production env 
	...
	public string Version { get { return "1.3.3"; } }
...
#if CommonSDK
        CommonSDKPlaform.Instance.CreateRoleToSDK(curCreateName);
#endif
    }
