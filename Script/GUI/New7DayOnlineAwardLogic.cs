...
using Module.Log;
public class New7DayOnlineAwardLogic : MonoBehaviour
{
    ...
    void init()
    {
        m_OnlineAwardID = GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineAwardID;
        m_LeftTime = GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayLeftTime;
        if (GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineAwardStart)        {
    ...
    void OnAwardClick()
    {
        int nMaxRecordCount = GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineAwardTable.Count;//TableManager.GetOnlineAward().Count;
        ...
        // 发包 领取
        GameManager.gameManager.PlayerDataPool.AwardActivityData.SendAwardPacket(AwardActivityType.AWARD_NEW7DAYONLINE);
    }
    ...
    void UpdateWindow()
    {
        ...
        for (int i = 0; i < nMaxRecordCount; i++)
        {
            ...
            // 更新选中状态
            if (m_OnlineAwardID == i && GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineAwardStart)
            {
    ...
    void UpdateLeftTime()
    {
        ...
        if (m_LeftTimeText != null && GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineAwardStart)
        {
    ...
    {
        int nMaxRecordCount = GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineAwardTable.Count;
    ...
    void UpdateDate()
    {
        int nStartMonth = GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineDateTime.StartDate % 10000 / 100;
        int nStartDay = GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineDateTime.StartDate % 100;
        int nEndMonth = GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineDateTime.EndDate % 10000 / 100;
        int nEndDay = GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineDateTime.EndDate % 100;
        string szSecond = (GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineDateTime.StartTime % 100).ToString();
        if (GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineDateTime.StartTime % 100 < 10)        {
            szSecond = "0" + szSecond;        }

        string szStartTime = (GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineDateTime.StartTime % 10000 / 100).ToString() + ":" + szSecond;

        szSecond = (GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineDateTime.EndTime % 100).ToString();
        if (GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineDateTime.EndTime % 100 < 10)
        {
            szSecond = "0" + szSecond;
        }
        string szEndTime = (GameManager.gameManager.PlayerDataPool.AwardActivityData.New7DayOnlineDateTime.EndTime % 10000 / 100).ToString() + ":" + szSecond;
    ...
    public void PlayEffect(int nNewOnlineAwardID)
    {
        ...
        if (nIndex >= 0 && nIndex < AwardActivityData.MaxNew7DayOnlineAwardCount)
        {
            if (nIndex < m_AwardItem.Length && m_AwardItem[nIndex] != null)
